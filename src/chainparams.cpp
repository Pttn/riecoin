 ...
 * database.
 */
static CBlock CreateGenesisBlock(uint64_t nTime, arith_uint256 nOffset, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward, const char* pszTimestamp = "The Times 10/Feb/2014 Thousands of bankers sacked since crisis")
{
...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 1482768;
        ...
        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 0531ac83b4ec8ee5699fe8cbd591ffbdaf369187fb75227449bc640a9e19dd1a
            /* nTime    */ 1617641698,
            /* nTxCount */ 2902206,
            /* dTxRate  */ 0.01033824577499979,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        checkpointData = {
            {
                {93526, uint256S("0x341bf23c88795ed4c79f73f5fe9c2a3a0b52a52149600f29ff86cc9318087d01")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 341bf23c88795ed4c79f73f5fe9c2a3a0b52a52149600f29ff86cc9318087d01
            /* nTime    */ 1617641731,
            /* nTxCount */ 97674,
            /* dTxRate  */ 0.00709633009670954,
        };
    }
};
